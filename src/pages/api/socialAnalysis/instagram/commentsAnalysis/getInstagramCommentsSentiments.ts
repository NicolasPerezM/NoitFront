...
export function GET({ request, params }: Parameters<APIRoute>[0]) {
  return (async () => {
    try {
      console.log('🔍 Iniciando petición a Instagram comment sentiments...');
      ...
      console.log('💬 Comentarios con sentiment encontrados:', data?.results?.length || 0);
      ...
      console.log('✅ Análisis de sentimientos de comentarios de Instagram obtenido exitosamente');
      ...
      console.log('📈 Distribución de sentimientos:', sentimentCounts);
